...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    # Company-wide handling contract: every profile must interpret a
    # representative-action card identically, even when it has no Kanban tools.
    stable_parts.append(REPRESENTATIVE_ACTION_GUIDANCE)
